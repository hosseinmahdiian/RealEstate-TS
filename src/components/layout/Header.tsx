  ...
  return (
    <div className="sticky top-1 z-10 flex h-14 items-center justify-between rounded-xl bg-blue-500 px-5">
      <div className="pt flex items-center gap-2.5">
        <Link className="font-bold text-white hover:scale-x-105 ease-in-out transition-all" href="/">
          صفحه اصلی
        </Link>
        <Link className="font-bold text-white hover:scale-x-105 ease-in-out transition-all" href="/buy-residential ">
          آگهی ها
        </Link>
      </div>
      <>
